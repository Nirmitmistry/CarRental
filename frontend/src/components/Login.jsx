...
const Login = () => {
    const { setshowLogin, axios, setToken , user,setUser} = useAppContext();
    ...
    const onSubmitHandler = async (event) => {
        try {
            ...
            if (data.success) {
                // ✅ Set token, save to localStorage, and then navigate
                setToken(data.token);
                ...
                navigate('/'); // ✅ Navigate only after setting token
            } else {
